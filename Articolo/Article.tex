...
Due to their rarity, events like mutational occurrances during evolution, atmospheric pollutions or natural disasters have long captured the public's attention and often they are shrouded in mystery.\\
...
Moreover, in the few last decades the \textit{EVT} literature has grown considerably, with applied interest in engineering, oceanography, environment and economics, among others, that is because it allows us extrapolate informations beyond the range of available data.
\\
...
\subsection{\textit{Extreme daily high gust in Ireland}}
